window.FOODWEB_DATA = {
  "meta": {
    ...
    "provenance": {
      "forcing_zh": "物理强迫为真实/公开数据：三峡水库水位调度曲线（正常蓄水位 175 m，防洪限制水位约 145 m，汛期消落、9–10 月蓄水）与长江中游月均水温气候态（约 11–28 ℃）。数值为代表性近似，非某一年逐日实测。",
      "forcing_en": "Physical forcing uses real/published data: the Three Gorges Reservoir water-level operation curve (normal pool 175 m, flood-limit ~145 m, drawdown then Sep–Oct refill) and middle-Yangtze monthly water-temperature climatology (~11–28 °C). Values are representative approximations, not a specific measured daily series.",
      "trophic_zh": "食物网结构与生物量量级参照已发表的长江中游 / 三峡库区 Ecopath 模型（见 ../08-references.md），为文献一致的合成参数化，非单一实测配平。",
      "trophic_en": "Food-web structure and biomass magnitudes follow published middle-Yangtze / Three Gorges Ecopath models (see ../08-references.md); a literature-consistent synthetic parameterization, not a single measured balance."
    }
  },
  "physics": {
    "anchor_zh": "三峡库区（干流库段）",
    "anchor_en": "Three Gorges Reservoir mainstem",
    "waterLevel_m":  [173, 168, 162, 156, 150, 146, 146, 148, 156, 168, 175, 174],
    "waterLevel_note": "月代表值 / monthly representative (m). 175=正常蓄水位, 145=防洪限制水位.",
    "temp_c":        [11, 11.5, 14, 18, 22, 25, 27.5, 28, 25, 21, 16.5, 13],
    "temp_note": "长江中游表层月均水温气候态 / middle-Yangtze surface water-temperature climatology (°C).",
    "spawnTempThreshold_c": 18,
    "dispatchPeakMonth": 5,
    "coupling": {
      "q10": 2.3, "tRef": 20,
      "tempPhotoStrength": 0.7,
      "lightSelfShade": 0.6,
      "stratSummerMonths": [6, 7, 8],
      "drawdownSubsidyStrength": 0.5,
      "clarityRefPhyto": 30
    }
  },
  "patches": [
  ...
  "scenarios": [
    ...
    { "id": "dispatch", "name_zh": "生态调度", "name_en": "Ecological dispatch",
      "desc_zh": "5 月人工洪峰，与自然水温产卵信号（≥18℃）对齐→四大家鱼补充脉冲。", "desc_en": "May engineered flood pulse aligned with the natural ≥18°C spawning cue → recruitment pulse for the four major carps.",
      "dispatch": true },
